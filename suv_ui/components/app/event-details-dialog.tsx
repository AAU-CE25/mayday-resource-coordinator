...
export function EventDetailsDialog({
  ...
  const locationParts = [];
  if (event.location.address?.street)
    locationParts.push(event.location.address.street);
  if (event.location.address?.city)
    locationParts.push(event.location.address.city);
  if (event.location.address?.postcode)
    locationParts.push(event.location.address.postcode);
        ...
        <div className="overflow-y-auto flex-1">
          ...
          <div className="bg-gray-50 rounded-lg p-3 text-sm">
            ...
            <div className="flex items-center gap-2 text-gray-600">
              ...
              <span className="text-gray-700">
                {formatDate(event.modified_time)}
              </span>
            </div>
          </div>
          ...
          <div>
            ...
            {volunteers.length > 0 ? (
              ...
              <p className="text-gray-500 text-sm">
                No active volunteers yet. Be the first!
              </p>
            )}
          </div>
                    ...
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-amber-800 text-sm">
                          You are currently assigned to another event:{" "}
                          <span className="font-medium">
                            {activeEventDescription}
                          </span>
                        </p>
                        <p className="text-amber-700 text-xs mt-2">
                          You must leave your current event before joining a new
                          one.
                        </p>
                      </div>
                    </div>
