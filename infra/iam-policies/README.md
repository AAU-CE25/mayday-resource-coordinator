...
| `github-terraform-core-policy.json` | `terraform-core.yml` | Terraform - Lambda, API Gateway, DynamoDB, S3 website |
...
> **Note:** The main Terraform policy is split into two parts (networking + services) to stay within AWS's 6KB policy size limit. The ECR and core policies are separate for standalone stacks.
